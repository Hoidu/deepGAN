...
parser.add_argument('--experiment_dir', help='', nargs='?', type=str, default='./01_experiments/04_runs/2019-01-31_15-31-31_deepGAN_exp_sd_1111_ep_4000_gs_8_rd_0.8_sd_0.015_mb_128_eco_relu_gpu_True')
parser.add_argument('--seed', help='', nargs='?', type=int, default=1234)
parser.add_argument('--no_epochs', help='', nargs='?', type=int, default=1201)
